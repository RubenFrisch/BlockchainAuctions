...
/// @title IPFS metadata manager abstract contract appendage
/// @author Ruben Frisch (ÓE-NIK, Business Informatics MSc)
/// @notice This contract enables the management of IPFS metadata for auctions
/// @dev This contract enables the management of IPFS metadata for auctions
abstract contract IPFSMetadataManager {
