...
contract AuctionsLogic is OwnershipController, CancellableAuctionController, WhitelistAuctionController, IPFSMetadataManager, EntryFeeManager {
        ...
        returns (bool) 
    {
        ...
        require(!hasPaidEntryFee(auctionID_, msg.sender), "Already paid the entry fee!");
        ...
        returns (bool) 
    {
        ...
        require(getEntryFee(auctionID_) > 0, "There is no entry fee at this auction!");
        require(hasPaidEntryFee(auctionID_, msg.sender), "Has not paid entry fee!");
        require(!hasWithdrawnEntryFee(auctionID_, msg.sender), "Already withdrawn the entry fee!");
