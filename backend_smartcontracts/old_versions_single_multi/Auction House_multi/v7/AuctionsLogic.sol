...
contract AuctionsLogic is OwnershipControl, Cancellable, WhitelistedAuction {
        ...
        returns (bool) 
    {
        ...
        require(AuctionERC721(nftContractAddress_).ownerOf(nftTokenID_) == address(this),"NFT must be transferred to the contract!");
