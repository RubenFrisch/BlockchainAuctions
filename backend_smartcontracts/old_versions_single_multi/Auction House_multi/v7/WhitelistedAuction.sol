...
abstract contract WhitelistedAuction {
    ...
    event AuctionConfiguredAsClosed(bytes32 indexed auctionID_, address owner_);
    event AddedWhitelistedParticipants(bytes32 indexed auctionID_, address owner_);
    ...
    function _configureAsClosedAuction(bytes32 auctionID_) internal {
        ...
        emit AuctionConfiguredAsClosed(auctionID_, msg.sender);
    }
    ...
    function _whitelistParticipants(bytes32 auctionID_, address[] memory participants_) internal {
        ...
        emit AddedWhitelistedParticipants(auctionID_, msg.sender);
    }
