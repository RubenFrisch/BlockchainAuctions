...
abstract contract Ownable {
    ...
    function transferOwnership(address newOwner_) public virtual onlyOwner {
        require(newOwner_ != address(0), "TRANSACTION ERROR: only non-zero address arguments are allowed with normal ownership transfers!");
    ...
    function getOwnerData(address ownerAddress_) public view onlyOwner returns (OwnerData memory) {
        return (_ownerMap[ownerAddress_]);
    }
}